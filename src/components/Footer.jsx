...
function Footer() {
  return (
    <footer className="footer-root border-t border-slate-200 bg-white px-6 py-10 text-slate-600 transition-colors duration-300 dark:border-white/10 dark:text-slate-300">
      <div className="mx-auto max-w-6xl">
        <div className="footer-panel grid gap-8 rounded-3xl border border-slate-200 bg-slate-50/80 p-6 shadow-sm shadow-slate-200/70 transition-colors duration-300 dark:border-white/10 dark:shadow-black/20 sm:p-8 lg:items-start">
          <div className="max-w-md">
            ...
            <p className="mt-3 text-sm leading-6">
              A developer passionate about crafting efficient and scalable products.<br/>
            ...
            <div>
              ...
              <div className="mt-4 space-y-3 text-sm">
                <a
                  ...
                  className="flex items-center gap-3 transition hover:text-cyan-700 dark:hover:text-cyan-300"
                >
