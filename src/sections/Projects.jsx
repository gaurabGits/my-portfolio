...
function Projects() {
  return (
    <section id="projects" className="scroll-mt-28 px-6 py-24 text-slate-950 transition-colors duration-300 dark:text-white">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {projects.map((project, index) => (
            <article
              key={project.title}
              className="group rounded-2xl border border-slate-300 bg-white p-6 shadow-xl shadow-slate-300/60 transition hover:-translate-y-1 hover:border-cyan-600/50 hover:bg-slate-50 dark:border-white/10 dark:bg-slate-900/50 dark:shadow-none dark:hover:border-cyan-300/40 dark:hover:bg-slate-900/80"
            >
