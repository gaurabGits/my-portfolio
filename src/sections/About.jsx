...
function About() {
  return (
    <section id="about" className="scroll-mt-28 px-6 py-24 text-slate-950 transition-colors duration-300 dark:text-white">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
        <div>
          ...
          <p className="mt-6 leading-8 text-slate-700 justify-start text-justify dark:text-slate-300">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-950/95 shadow-2xl shadow-slate-300/40 dark:border-white/10 dark:bg-slate-950/80 dark:shadow-black/30">
          ...
          <div className="overflow-x-auto p-5 font-mono text-sm leading-8 sm:text-base">
            {codeLines.map((line) => (
              <div key={`${line.number}-${line.text}`} className="flex gap-5">
          ...
          <div className="border-t border-white/10 bg-white/3 px-5 py-4 font-mono text-sm text-slate-400">
